    ...
    if (contactForm) {
        ...
        contactForm.addEventListener('submit', function(e) {
            ...
            if (isValid) {
                ...
                .then(function(response) {
                    if (response.ok) {
                        showFormMessage(contactForm, 'success', 'Thank you! Your message has been sent.');
                        contactForm.reset();
                        fields.forEach(function(field) {
                ...
                .catch(function(error) {
                    showFormMessage(contactForm, 'error', 'Oops! Something went wrong. Please try again.');
                })
                .finally(function() {
                    if (submitButton) {
        ...
        function showFormMessage(form, type, message) {
            ...
            if (!messageElement) {
                ...
                messageElement.style.cssText = 'padding: 1rem; margin-top: 1rem; border-radius: 4px;';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '02ddf77f-84fb-4721-b32c-8d51e9ef570e',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '02ddf77f-84fb-4721-b32c-8d51e9ef570e';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '02ddf77f-84fb-4721-b32c-8d51e9ef570e';
